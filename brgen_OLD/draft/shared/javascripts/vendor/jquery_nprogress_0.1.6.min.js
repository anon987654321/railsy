...
c.configure=function(a){var b,d;for(b in a)d=a[b],void 0!==d&&a.hasOwnProperty(b)&&(e[b]=d);return this};c.status=null;c.set=function(a){var b=c.isStarted();a=f(a,e.minimum,1);c.status=1===a?null:a;var d=c.render(!b),n=d.querySelector(e.barSelector),k=e.speed,u=e.easing;d.offsetWidth;v(function(b){""===e.positionUsing&&(e.positionUsing=c.getPositioningCSS());l(n,h(a,k,u));1===a?(l(d,{transition:"none",opacity:1}),d.offsetWidth,setTimeout(function(){l(d,{transition:"all "+k+"ms linear",opacity:0});
...
c.isRendered=function(){return!!document.getElementById("nprogress")};c.getPositioningCSS=function(){var a=document.body.style,b="WebkitTransform"in a?"Webkit":"MozTransform"in a?"Moz":"msTransform"in a?"ms":"OTransform"in a?"O":"";return b+"Perspective"in a?"translate3d":b+"Transform"in a?"translate":"margin"};var v=function(){function a(){var d=b.shift();d&&d(a)}var b=[];return function(d){b.push(d);1==b.length&&a()}}(),l=function(){function a(a){return a.replace(/^-ms-/,"ms-").replace(/-([\da-z])/gi,
function(a,b){return b.toUpperCase()})}function b(b){b=a(b);var e;if(!(e=c[b])){e=c;var w=b;a:{var s=document.body.style;if(!(b in s))for(var t=d.length,g=b.charAt(0).toUpperCase()+b.slice(1),f;t--;)if(f=d[t]+g,f in s){b=f;break a}}e=e[w]=b}return e}var d=["Webkit","O","Moz","ms"],c={};return function(a,d){var c=arguments,e,f;if(2==c.length)for(e in d){if(f=d[e],void 0!==f&&d.hasOwnProperty(e)){var c=a,g=e,g=b(g);c.style[g]=f}}else e=a,g=c[1],c=c[2],g=b(g),e.style[g]=c}}();return c});
